...
}, {"../../lib/display-source":2,"../../lib/dialog-modal/dialog-modal.js":3,"component/query":4,"./modal-body.html":5,"./source":6}],
...
}, {"component/emitter":7,"component/events":8,"isner/aria-isolate":9,"./overlay":10,"./modal":11}],
...
}, {"component/emitter":7,"component/events":8}],
...
}, {"stephenmathieson/focus-trap":18,"component/emitter":7,"component/classes":16,"component/events":8}],
...
}, {"focusable-elements":19,"event":12,"normalize":20}],
...
}, {"is-focusable":21,"descendants":22}],
...
module.exports = [{"name":"index.jade","code":"\nextends ../layout\n\nblock vars\n  - var heading = 'Alert Dialog'\n\nblock content\n  .panel.panel-default\n    .panel-heading\n      h2 Example: Alert Dialog\n\n    .panel-body\n      p An Alert Dialog is a simple dialog with a message that alerts, warns, or requests confirmation (e.g., \"Are you sure you want quit?\"). In most ways, an Alert Dialog is identical to a Modal Dialog.\n      \n      .form-group\n        .btn-group\n          button.btn.btn-default Trigger Alert\n\nblock scripts\n  script(src=\"index.js\")\n\nblock styles\n  link(rel=\"stylesheet\" href=\"index.css\")\n"},{"name":"index.js","code":"\n/**\n * Module dependencies.\n */\n\nvar displaySource = require('../../lib/display-source');\nvar DialogModal = require('../../lib/dialog-modal/dialog-modal.js');\nvar query = require('component/query');\n\n/**\n * Define arguments.\n */\n\nvar trigger = query('.btn-default');\nvar content = require('./modal-body.html');\nvar title = 'Example Alert';\n\n/**\n * Create an alert-dialog using the above arguments.\n */\n\nnew DialogModal(trigger, content, title, true);\n\n/**\n * Display the source files.\n */\n\ndisplaySource(require('./source'));\n"},{"name":"index.styl","code":"\n@require '../global'\n\n.ital\n  font-style italic\n\n.visualize-hidden\n  background-color red !important"},{"name":"modal-body.html","code":"<p>An important message can be displayed here.</p>\n"}];
}, {}]}, {}, {"1":""})